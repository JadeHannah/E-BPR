# inference float mask for merge with GPU check
import argparse
import os
...
def main():
    ...
    if torch.cuda.is_available():
        ...
        print("⚠️  WARNING: CUDA is not available! Model will run on CPU.")
    print("=" * 60 + "\n")
    ...
    if not distributed:
        ...
        if torch.cuda.is_available():
            ...
            if first_param.device.type != 'cuda':
                print("⚠️  WARNING: Model is not on GPU after MMDataParallel!")
